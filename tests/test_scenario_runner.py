...
def test_scenario_runner_creates_log(tmp_path: Path):
    scenario_path = Path("scenarios/example_secret_scenario.json")
    feedback, log_path = run_scenario(scenario_path, participant_name="Scripted", position="Dev", grade="Middle", experience="5y")
